...
const NavbarComponent = ({setShowTodosList, showLoginModal, showRegModal, showLogoutModal}) => {
	return (
		<nav className="navbar fixed-bottom bg-primary py-2 px-3 text-light container-md" style={{borderRadius: '1.3em 1.3em 0 0'}}>
			<div className="py-1 d-flex">
				<a href="#" className="me-3" title='Todooos.live - best todos ever '>
			...
			<div className="d-flex">
				...
				<Dropdown drop='up' align="end" className="rounded-circle bg-light cursor-pointer">
					<Dropdown.Toggle as={SvgToggle} id="dropdown-custom-components" >
					</Dropdown.Toggle>
