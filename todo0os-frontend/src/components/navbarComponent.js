...
const NavbarComponent = ({setShowTaskList}) => {
	return (
		<nav className="navbar fixed-bottom bg-primary py-2 px-3 text-light container-md" style={{borderRadius: '1.3em 1.3em 0 0'}}>
			...
			<div className="d-flex">
				<div className="me-3 d-flex align-items-center cursor-pointer" onClick={()=>setShowTaskList(true)}>
